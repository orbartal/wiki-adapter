...
public abstract class AbstractCrudController4C <T> implements CrudController4I<T> {

	@ApiOperation(value = "crud: get entities by page")
	@RequestMapping(method = RequestMethod.GET, produces = "application/json")
	public Page<T> get(
			@ApiParam(value = "The entity grand greate parent id", required = true) @PathVariable("parentId3") String parentId3,
